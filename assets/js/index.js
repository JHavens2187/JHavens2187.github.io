// Ensure we are grabbing the right container
const link_container = document.getElementById("link-container");

if (!link_container) {
    console.error("Error: Could not find 'link-container' in index.html");
} else {
    // Clear any existing hardcoded content
    link_container.innerHTML = "";

    // Descriptions to fill out the Bento cards based on your research and projects
    const descriptions = {
    ...
    // Loop through the links defined in config.js
    config.links.forEach(link => {
        const col = document.createElement("div");
        
        // Logic: Research and Projects get larger columns (6), others are smaller (4)
    ...
    console.log("Tiles successfully generated from config.js");
}
